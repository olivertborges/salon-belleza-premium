...
export default function EsteticaPage() {
  ...
  const getIcon = (iconName: string) => {
    const icons: Record<string, any> = {
      Sparkles, Sparkle, Flower2, Droplets, Feather, Eye, Crown, Star, Heart, Gem, Palette
    }
                ...
                serviciosFiltrados.map((servicio) => {
                  ...
                  return (
                    <motion.div key={servicio.id} variants={itemVariants}>
                      <div
                        className={`group relative rounded-2xl border p-4 sm:p-5 transition-all duration-300 transform hover:-translate-y-0.5 flex flex-col justify-between min-h-[200px] sm:min-h-[220px] overflow-hidden cursor-pointer ${
                          isDark
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="space-y-1">
                            <h4 className="font-black text-xs sm:text-sm tracking-tight text-stone-900 dark:text-stone-200 group-hover:text-pink-500 transition-colors">
                              {servicio.name}
                            </h4>
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 mt-2">
                            {avgRating > 0 ? (
                              <>
                                ...
                                <span className="text-[9px] sm:text-[10px] font-bold text-stone-600 dark:text-stone-400">
                                  {avgRating.toFixed(1)}
                                </span>
                        ...
                        <div className={`flex items-center justify-between border-t border-dashed mt-3 sm:mt-4 pt-3 sm:pt-3.5 ${
                          isDark ? 'border-stone-800/80' : 'border-stone-100'
                        }`}>
                          <div className="flex items-center gap-2">
                            <span className={`text-sm sm:text-base font-mono font-black tracking-tight ${
