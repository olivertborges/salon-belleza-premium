...
export default function PeluqueriaPage() {
  ...
  // ============================================================
  // 🔥 CARGAR GALERÍA - FOTOS CON CATEGORÍA PELUQUERÍA
  // ============================================================
  const loadGallery = async () => {
    ...
    try {
      console.log('🔍 Cargando galería de peluquería para tenant:', activeTenantId)

      let allImages: GalleryImage[] = []

      // 1. Fotos de ADMIN (tabla gallery) con categoría Peluquería
      ...
      if (adminError) {
        ...
        console.log(`📸 Encontradas ${adminPhotos.length} fotos de admin con categoría Peluquería`)
      ...
      // 2. Fotos de CLIENTES (tabla client_gallery) con categoría Peluquería
      ...
      if (clientError) {
        ...
        console.log(`📸 Encontradas ${clientPhotos.length} fotos de clientes con categoría Peluquería`)
      ...
      console.log(`✅ Total: ${allImages.length} fotos de peluquería cargadas`)
