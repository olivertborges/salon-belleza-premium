...
const MicropigmentacionLoadingSpinner = ({ isDark }: { isDark: boolean }) => (
...
export default function MicropigmentacionPage() {
  ...
  if (loading) {
    return <MicropigmentacionLoadingSpinner isDark={isDark} />
  }
          ...
          <div className="relative z-10 p-6 md:p-12 max-w-3xl w-full">
            <div className="text-white">
              ...
              <p className="text-sm md:text-base text-white/70 mt-3 max-w-md font-light tracking-wide">
                Especialista en microblading, microshading y técnicas avanzadas para realzar tu belleza natural.
              </p>
