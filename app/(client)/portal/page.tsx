...
<div className="mt-6">
  <PromocionesVolante limit={6} showTitle={true} />
    ...
    <RuletaModal
      ...
      tenantIdActivo={tenantId ?? undefined} // ✨ Aquí se resuelve el misterio
    />
    </div>
  )
}