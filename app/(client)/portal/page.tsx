...
import { Calendar, Sparkles, Gift, ArrowRight, RefreshCw, Trophy, Crown, CheckCircle2, Clock, Gem, Star, Flame, Compass, Heart, Zap, Award, Shield, Sun, Moon, PartyPopper } from 'lucide-react'
...
export default function ClientDashboardIndex() {
  ...
  return (
    <div className={`space-y-8 max-w-5xl mx-auto w-full px-4 pb-20 antialiased transition-all duration-700 ${
      isDark ? 'text-zinc-100 bg-gradient-to-b from-[#09090b] via-[#0d0d12] to-[#09090b]' : 'text-stone-900 bg-gradient-to-b from-stone-50 via-white to-stone-50/50'
    }`}>

      {/* ============================================================ */}
      {/* 👑 HERO BANNER — PRESTIGE EDITION */}
      {/* ============================================================ */}
      <div className={`relative overflow-hidden rounded-[2.5rem] border transition-all duration-700 p-7 md:p-10 shadow-2xl ${
        isDark 
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          ...
          <div className="space-y-6 w-full lg:w-auto">
            {/* Badge saludo */}
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full backdrop-blur-xl bg-white/5 border border-white/10 shadow-lg">
              <span className="text-xl">{saludo.emoji}</span>
              <span className="text-[10px] uppercase tracking-[0.2em] font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-rose-300 to-amber-300">
                {saludo.text}
              </span>
            ...
            {/* Contador de puntos — Diseño BOUTIQUE */}
            <div className="grid grid-cols-2 gap-4 pt-1 max-w-sm w-full">
              {/* Glow Points */}
              <div className="relative group overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-br from-white/[0.06] to-transparent p-5 backdrop-blur-md hover:border-pink-500/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(219,91,154,0.08)]">
                ...
                <div className="relative flex items-baseline gap-2">
                  <span className="text-4xl font-black text-white tracking-tight">{puntosGlow}</span>
                  <span className="text-xs font-black tracking-[0.15em] text-pink-400">GLOW</span>
                </div>
                <div className="flex items-center gap-1.5 mt-1.5">
                  <Gem className="w-3 h-3 text-pink-400/60" />
                  <span className="text-[9px] font-medium tracking-[0.1em] text-zinc-400 group-hover:text-pink-400/80 transition-colors">Estética Premium</span>
                </div>
              ...
              {/* Hair Points */}
              <div className="relative group overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-br from-white/[0.06] to-transparent p-5 backdrop-blur-md hover:border-amber-500/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(245,158,11,0.08)]">
                ...
                <div className="relative flex items-baseline gap-2">
                  <span className="text-4xl font-black text-white tracking-tight">{puntosHair}</span>
                  <span className="text-xs font-black tracking-[0.15em] text-amber-400">HAIR</span>
                </div>
                <div className="flex items-center gap-1.5 mt-1.5">
                  <Star className="w-3 h-3 text-amber-400/60" />
                  <span className="text-[9px] font-medium tracking-[0.1em] text-zinc-400 group-hover:text-amber-400/80 transition-colors">Stylist & Color</span>
                </div>
                <div className="mt-3 h-0.5 w-full bg-white/5 rounded-full overflow-hidden">
            ...
            <button 
              ...
              disabled={refreshing} 
              className="inline-flex items-center gap-3 text-[9px] font-black tracking-[0.2em] uppercase px-5 py-3 rounded-xl transition-all duration-300 active:scale-95 border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 text-zinc-300 hover:text-white group"
            >
              <RefreshCw className={`w-3.5 h-3.5 text-pink-400/70 group-hover:text-pink-400 transition-colors ${refreshing ? 'animate-spin' : ''}`} /> 
              {refreshing ? 'Sincronizando...' : 'Sincronizar Cuenta'}
            </button>
          </div>
          ...
          <Link 
            href="/agenda" 
            className="w-full lg:w-auto relative group overflow-hidden px-8 py-5 rounded-2xl font-black text-xs tracking-[0.25em] uppercase transition-all duration-500 transform active:scale-[0.97] hover:-translate-y-1 flex items-center justify-center gap-4 bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600 text-white border border-pink-400/20 shadow-[0_15px_40px_rgba(219,91,154,0.35)] hover:shadow-[0_25px_50px_rgba(219,91,154,0.5)] group"
          >
            {/* Efecto shine */}
      ...
      {/* ============================================================ */}
      {/* 📢 ANUNCIOS Y PROMOCIONES — RE-ESTRUCTURADOS CON GLASS */}
      {/* ============================================================ */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        <div className={`transition-all duration-500 hover:translate-y-[-3px] rounded-3xl overflow-hidden shadow-lg ${
      ...
      <div className={`transition-all duration-500 hover:scale-[1.01] rounded-3xl overflow-hidden shadow-xl ${
      ...
      {/* ============================================================ */}
      {/* 📅 PRÓXIMOS TURNOS — BENTO LUXURY */}
      {/* ============================================================ */}
      <div className={`p-7 md:p-9 rounded-3xl border transition-all duration-500 shadow-2xl ${
        isDark 
          ? 'bg-gradient-to-br from-zinc-950/60 via-zinc-950/30 to-zinc-950/60 border-zinc-900/60 shadow-black/40' 
          : 'bg-gradient-to-br from-white via-stone-50/80 to-white border-stone-200/60 shadow-stone-300/30'
      }`}>
        {/* Header con diseño premium */}
        <div className="flex justify-between items-center mb-7 pb-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black tracking-tight">Tus <span className="font-serif italic font-normal text-pink-500">Próximas</span> Citas</h2>
              <p className="text-[10px] font-medium tracking-wider text-zinc-400 dark:text-zinc-500">Consiente tu agenda</p>
            </div>
          </div>
          <span className={`text-[10px] font-black uppercase tracking-wider px-4 py-1.5 rounded-full border ${
            isDark 
        ...
        {citasProximas.length === 0 ? (
          <div className={`text-center py-16 border border-dashed rounded-2xl transition-all ${
            ...
            <p className="text-[10px] text-zinc-500 dark:text-zinc-600 mt-1 tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {citasProximas.slice(0, 4).map((cita: any, index: number) => (
              <div 
                key={cita.id} 
                className={`group p-5 rounded-2xl border flex justify-between items-center relative overflow-hidden transition-all duration-500 shadow-sm hover:shadow-xl ${
                  isDark 
              ...
              >
                ...
                <span className="absolute left-0 inset-y-0 w-1 rounded-r-full bg-gradient-to-b from-pink-500 via-rose-500 to-amber-400 shadow-[0_0_15px_rgba(219,91,154,0.3)]" />
                ...
                <div className="space-y-1.5 pl-4 flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs font-medium text-zinc-500 dark:text-zinc-400 flex-wrap">
                    <span className="flex items-center gap-1.5">
                      <Calendar className="w-3.5 h-3.5 text-pink-400/70" />
                      {cita.date}
                    </span>
                ...
                <div className="shrink-0 ml-2">
                  {cita.status === 'confirmed' ? (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[8px] font-black uppercase tracking-[0.15em] bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/15">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                      Confirmada
                    </span>
                  ) : (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[8px] font-black uppercase tracking-[0.15em] bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/15">
        ...
        {citasProximas.length > 4 && (
          <div className="mt-5 text-center">
            <Link 
              href="/mis-citas" 
              className={`text-[10px] font-black uppercase tracking-[0.2em] transition-all hover:tracking-[0.3em] inline-flex items-center gap-2 ${
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className={`rounded-3xl overflow-hidden shadow-xl transition-all duration-500 hover:shadow-2xl ${
      ...
      {/* QR Referido — con glass effect */}
      <div className={`transition-all duration-500 hover:translate-y-[-2px] rounded-3xl overflow-hidden shadow-2xl ${
      ...
      <div className={`p-3 rounded-[2.5rem] border transition-all duration-500 ${
        isDark 
          ? 'bg-gradient-to-br from-zinc-950/40 via-zinc-950/20 to-zinc-950/40 border-zinc-900/60 shadow-black/30' 
          : 'bg-gradient-to-br from-white via-stone-50/60 to-white border-stone-200/50 shadow-stone-300/20'
      }`}>
        <InsigniasLogros 
          citas={citas.length} 
      ...
      {/* ============================================================ */}
      {/* 🎡 LUCKY WHEEL — GAMIFICATION LUXE */}
      {/* ============================================================ */}
      <div className={`p-7 md:p-9 rounded-3xl border flex flex-col sm:flex-row items-center justify-between shadow-2xl relative overflow-hidden transition-all duration-700 hover:shadow-3xl ${
        isDark 
          ? 'bg-gradient-to-br from-pink-950/15 via-zinc-950 to-amber-950/10 border-pink-950/20 shadow-black/40' 
          : 'bg-gradient-to-br from-pink-50/80 via-amber-50/40 to-stone-50/80 border-pink-200/30 shadow-pink-200/30'
      }`}>
        {/* Fondo decorativo */}
        ...
        <div className="absolute -bottom-20 left-20 w-40 h-40 bg-amber-500/5 rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="flex items-center gap-6 z-10 w-full sm:w-auto">
          <div className="relative">
            <div className={`p-4 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 text-white shadow-2xl shadow-pink-500/30 shrink-0 transform transition-all duration-500 hover:scale-110 hover:rotate-3 ${
              ...
              <Gift className="w-7 h-7 animate-[bounce_2s_ease-in-out_infinite]" />
            </div>
            {/* Anillo decorativo */}
          ...
          <div className="space-y-1.5">
            <h3 className="text-xl font-black tracking-tight flex items-center gap-2">
              ...
              <PartyPopper className="w-4 h-4 text-amber-400 inline-block" />
            </h3>
            <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400 tracking-wide max-w-xs">
              Gira la ruleta Fresh y reclama obsequios VIP instantáneos. ¡Un premio te espera!
            </p>
            <div className="flex items-center gap-1.5 mt-1">
              {['✨', '💎', '🌟', '🎯'].map((emoji, i) => (
                <span key={i} className="text-sm animate-[bounce_2s_ease-in-out_infinite]" style={{ animationDelay: `${i * 0.2}s` }}>
                  {emoji}
                </span>
              ))}
            </div>
        ...
        <button 
          ...
          className={`w-full sm:w-auto mt-5 sm:mt-0 px-8 py-4.5 rounded-xl font-black text-xs tracking-[0.25em] uppercase transition-all duration-500 transform active:scale-95 hover:-translate-y-1 shadow-xl flex items-center gap-3 group relative overflow-hidden ${
            isDark 
