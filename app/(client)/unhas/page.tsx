...
const UnasLoadingSpinner = ({ isDark }: { isDark: boolean }) => (
...
export default function UnasPage() {
  ...
  const categories = [
    ...
    { id: 'Manicuría', label: 'Manicuría', icon: <Brush className="w-3.5 h-3.5" /> },
    { id: 'Pedicuría', label: 'Pedicuría', icon: <Scissors className="w-3.5 h-3.5" /> },
    { id: 'Tratamientos', label: 'Tratamientos', icon: <Heart className="w-3.5 h-3.5" /> },
    { id: 'Diseños', label: 'Diseños', icon: <Gem className="w-3.5 h-3.5" /> },
  ]
  ...
  const loadServicios = async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .eq('is_active', true)
        .in('category', ['Manicuría', 'Pedicuría', 'Tratamientos', 'Diseños', 'Uñas', 'unas', 'nails'])
  ...
  if (loading) {
    return <UnasLoadingSpinner isDark={isDark} />
  }
          ...
          <div className="relative z-10 p-6 md:p-12 max-w-3xl w-full">
            <div className="text-white">
              ...
              <p className="text-sm md:text-base text-white/70 mt-3 max-w-md font-light tracking-wide">
                Especialista en nail art, diseños exclusivos y tratamientos de uñas de alta calidad.
              </p>
                  ...
                  >
                    <div className="cursor-pointer space-y-3 relative z-10" onClick={() => openModal(servicio)}>
                      <div className="relative overflow-hidden rounded-xl aspect-video">
                        <img 
                          src={servicio.image_url || 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&h=400&fit=crop'} 
                          alt={servicio.name} 
                    ...
                    <div className={`flex items-center justify-between mt-4 pt-4 border-t relative z-10 ${
                      ...
                      <div className={`flex items-center gap-1 text-[10px] font-medium ${isDark ? 'text-[#A89588]' : 'text-[#5C4A3E]'}`}>
                        <Brush className="w-3 h-3 text-[#D4AF37]" />
                        {servicio.category || 'Uñas'}
                      </div>
                      <button 
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                        <h3 className="text-sm font-light truncate">{img.title || 'Trabajo de uñas'}</h3>
            ...
            >
              ...
              >
                <img 
                  ...
                  alt={selectedImage.title || 'Galería de uñas'}
            ...
            >
              ...
              >
                ...
                <div className="aspect-video rounded-xl overflow-hidden">
                  <img 
                    src={selectedService.image_url || 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&h=400&fit=crop'} 
                ...
                <div>
                  ...
                  <p className={`text-xs leading-relaxed mt-2 ${isDark ? 'text-[#A89588]' : 'text-[#5C4A3E]'}`}>
                    {selectedService.description || 'Experiencia de uñas premium diseñada para realzar tu estilo.'}
                  </p>
                </div>
