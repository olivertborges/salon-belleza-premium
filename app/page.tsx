        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1 relative">
            <div className="grid grid-cols-2 gap-4">
              <motion.div 
                className="aspect-[3/5] bg-gray-100 overflow-hidden shadow-lg"
          ...
          >
            <div className="relative aspect-[3/4] bg-[#F0E4DA] overflow-hidden shadow-2xl border border-[#F0E4DA] p-3 transition-transform duration-700 group-hover:scale-[1.01]">
              <img 
                ...
                alt="Silvana - Especialista en Alta Peluquería" 
                className="w-full h-full object-cover filter grayscale-[10%] group-hover:grayscale-0 transition-all duration-1000"
              />
              <div className="absolute inset-0 bg-[#1A0E0A]/5 group-hover:bg-transparent transition-all duration-700" />
              ...
              <div className="absolute -bottom-4 -right-4 md:right-6 bg-white p-6 shadow-xl border-l-4 border-[#D4AF37] max-w-xs transition-all duration-500 group-hover:translate-y-[-4px]">
                ...
                <h3 className="font-serif text-2xl text-[#1A0E0A] mt-1 font-light tracking-wide">Silvana</h3>
              </div>
            </div>

            <div className="pt-6 space-y-4 max-w-md">
              <p className="text-sm text-[#5C4A3E] font-light leading-relaxed">
                Maestra del movimiento y el color. Silvana diseña estilos capilares a medida analizando las facciones y la caída natural, garantizando un acabado elegante y orgánico.
              </p>
...
const GallerySection = ({ images }: { images: any[] }) => {
  ...
  const displayImages = images && images.length > 0 
    ? images 
    : [
        'https://kzovcbefedfmpeucrofh.supabase.co/storage/v1/object/public/gallery/IMG-20260805-WA0002.jpg',
          ...
          {displayImages.map((img, idx) => {
            ...
            return (
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: idx * 0.1 }}
                className="w-72 md:w-96 flex-shrink-0 snap-start group bg-white border border-[#F0E4DA] p-3 shadow-sm"
              >
