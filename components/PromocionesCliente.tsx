  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FDFBF7] dark:bg-neutral-950 flex flex-col items-center justify-center gap-4">
        ...
        <span className="text-xs tracking-[0.2em] uppercase text-[#B8965A] dark:text-[#C9A96E] font-medium font-sans">
    ...
    <div className="bg-[#FDFBF7] dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 min-h-screen relative overflow-x-hidden selection:bg-[#FF2A75]/20 font-sans transition-colors duration-300">
      ...
      <div className="relative border-b border-neutral-300 dark:border-neutral-800/60 overflow-hidden bg-white dark:bg-transparent">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-6">
          ...
          >
            <ArrowLeft className="w-3.5 h-3.5 stroke-[2]" /> Volver al Inicio
          </Link>

          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              <h1 className="text-4xl md:text-6xl font-light tracking-[0.1em] uppercase font-serif leading-none text-neutral-900 dark:text-white">
        ...
        {filteredPromociones.length === 0 ? (
          <div className="text-center py-24 rounded-3xl border border-dashed border-neutral-300 dark:border-neutral-800 max-w-md mx-auto space-y-4 bg-white dark:bg-transparent">
            ...
            <div className="space-y-1">
              <h3 className="text-xs font-sans tracking-wider uppercase font-semibold text-neutral-800 dark:text-white">Sin resultados</h3>
              <p className="text-xs text-neutral-500 dark:text-neutral-500 font-light px-6">
                No hay promociones activas con esos criterios.
              </p>
            </div>
            {searchTerm && (
              <button
    ...
    >
      ...
      <div className="p-6 space-y-5 relative z-10">
        ...
        {promo.image_url ? (
          ...
          <div className="rounded-xl aspect-video w-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-950/40 border border-neutral-200">
        ...
        <div className="flex items-center justify-between text-[9px] font-mono text-neutral-500 dark:text-neutral-500 pt-1">
          <div className="flex items-center gap-1">
            ...
            <span>Hasta: {new Date(promo.valid_until).toLocaleDateString('es-ES', { day: '2-digit', month: '2-digit', year: 'numeric' })}</span>
          </div>
          {promo.uses_limit && (
            <div className="flex items-center gap-1">
              <Eye className="w-3 h-3 stroke-[1.5]" />
              <span>{promo.uses_count || 0}/{promo.uses_limit}</span>
            </div>
          )}
        </div>
